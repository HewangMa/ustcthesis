...
\ustcsetup{
	title                = {面向C/C++静态分析工具的自动化评估系统设计和实现},
	title*               = {Design and implementation of an automated evaluation system for C/C++ static analysis tools},
	author               = {马禾旺},
	author*              = {Ma Hewang},
	speciality           = {软件工程},
	...
	supervisor*          = {Prof. Xie Xingsheng},
	practice-supervisor  = {张甫庆},  % 专业/工程学位的实践导师
	practice-supervisor* = {Zhang Fuqing},
